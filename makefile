...
build: 
	@go build -o svcPodKmsExporter

darwin:
	@CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o svcPodKmsExporter

linux:
	@CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o svcPodKmsExporter
